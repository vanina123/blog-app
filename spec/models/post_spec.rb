...
RSpec.describe Post, type: :model do
  ...
  context 'Testing with no inputs' do
    ...
    it 'return return_most_comment' do
      expect(subject.return_most_comment).to eq(subject.comments.order(updated_at: :desc).limit(5))
    end
  end
  context 'Testing with inputs' do
    ...
    it 'increments the author\'s posts_counter on save' do
